...
/// <summary>
/// The two fixed system prompts, adapter-supplied and never caller-supplied (closes off a
/// prompt-injection surface, per domain-interfaces-and-objects.md). Written to satisfy
/// ethics-by-design.md: neutral fact-reporting, no recommendations/nudging, and to describe
/// AggregateStats.Dimensions generically — no dimension name (including "category" or "date")
/// is assumed to mean anything beyond what its own name and bucket values say.
/// </summary>
internal static class ClaudePrompts
{
